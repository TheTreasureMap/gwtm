...
class ApiV1Tests(unittest.TestCase):
    ...
    @patch('src.api_v1.db')
    def test_get_pointings_v1_invalid_graceid(self, mock_db):
        models.db = mock_db
        mock_db.session.query(models.users).filter().first.return_value = MagicMock()  # mock for valid api_token
        mock_db.session.query().filter().all.return_value = []  # mock for invalid graceid
        mock_db.session.query(models.pointing).filter().all.return_value = [] # mock for
        response = self.client.get('/api/v1/pointings', query_string={
            'api_token': 'valid_api_token',
            'graceid': 'invalid_graceid'
        })
    ...
    @patch('src.api_v1.db')
    def test_get_pointings_v1_valid_multiple_graceids(self, mock_db):
        response = self.client.get('/api/v1/pointings', query_string={
            'api_token': valid_api_token,
            'graceids': valid_graceids
        })
        assert response.status_code == 200
        assert len(response.json) > 0

    @patch('src.api_v1.db')
    def test_get_pointings_v1_invalid_graceids_format(self, mock_db):
        response = self.client.get('/api/v1/pointings', query_string={
            'api_token': valid_api_token,
            'graceids': invalid_graceids
        })
        assert response.status_code == 500
        assert 'Error parsing' in response.json['message']

    @patch('src.api_v1.db')
    def test_get_pointings_v1_valid_id(self, mock_db):
        response = self.client.get('/api/v1/pointings', query_string={
            'api_token': valid_api_token,
            'id': valid_id
        })
    ...
    @patch('src.api_v1.db')
    def test_get_pointings_v1_invalid_id(self, mock_db):
        response = self.client.get('/api/v1/pointings', query_string={
            'api_token': valid_api_token,
            'id': invalid_id
        })
    ...
    @patch('src.api_v1.db')
    def test_get_pointings_v1_valid_band(self, mock_db):
        response = self.client.get('/api/v1/pointings', query_string={
            'api_token': valid_api_token,
            'band': valid_band
        })
    ...
    @patch('src.api_v1.db')
    def test_get_pointings_v1_invalid_band(self, mock_db):
        response = self.client.get('/api/v1/pointings', query_string={
            'api_token': valid_api_token,
            'band': invalid_band
        })
    ...
    @patch('src.api_v1.db')
    def test_get_pointings_v1_valid_status(self, mock_db):
        response = self.client.get('/api/v1/pointings', query_string={
            'api_token': valid_api_token,
            'status': valid_status
        })
    ...
    @patch('src.api_v1.db')
    def test_get_pointings_v1_invalid_status(self, mock_db):
        response = self.client.get('/api/v1/pointings', query_string={
            'api_token': valid_api_token,
    ...
    @patch('src.api_v1.db')
    def test_get_pointings_v1_valid_time_range(self, mock_db):
        response = self.client.get('/api/v1/pointings', query_string={
            'api_token': valid_api_token,
            **valid_time_range
        })
    ...
    @patch('src.api_v1.db')
    def test_get_pointings_v1_invalid_time_format(self, mock_db):
        response = self.client.get('/api/v1/pointings', query_string={
            'api_token': valid_api_token,
            **invalid_time_range
        })
