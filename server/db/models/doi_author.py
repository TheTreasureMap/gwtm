...
class DOIAuthor(Base):
    ...
    @staticmethod
    def construct_creators(doi_group_id: Union[int, str], userid: int, db: Session) -> Tuple[
    ...
    def authors_from_page(form_data):
        ...
        # Create authors
        for aid, an, aff, orc, gnd in zip(author_ids, author_names, affiliations, orcids, gnds):
