        ...
        try:
            ...
            if isFloat(spec_range_low) and isFloat(spec_range_high):
                ...
                if spec_range_type == "wavelength":
                    ...
                    unit = [x for x in WavelengthUnits if spec_range_unit == x.name][0]
                    ...
                    unit = [x for x in EnergyUnits if spec_range_unit == x.name][0]
                    ...
                    unit = [x for x in FrequencyUnits if spec_range_unit == x.name][0]
