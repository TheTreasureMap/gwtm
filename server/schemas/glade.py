...
class Glade2P3Schema(BaseModel):
    ...
    position: Optional[dict] = Field(
        None,
        description="Geographical position as a dictionary with 'latitude' and 'longitude'",
    )
    ...
    hyperleda_name: Optional[str] = Field(
        None, description="HyperLEDA name of the galaxy"
    )
    sdssdr12_name: Optional[str] = Field(
        None, description="SDSS DR12 name of the galaxy"
    )
