...
class GroupSchema(BaseModel):
    ...
    datecreated: Optional[datetime] = Field(
        None, description="Date when the group was created"
    )
...
class UserActionSchema(BaseModel):
    ...
    ipaddress: Optional[str] = Field(
        None, description="IP address from which the action was performed"
    )
    url: Optional[str] = Field(None, description="URL that was accessed")
    time: Optional[datetime] = Field(
        None, description="Time when the action was performed"
    )
    jsonvals: Optional[Dict[str, Any]] = Field(
        None, description="Additional JSON data for the action"
    )
