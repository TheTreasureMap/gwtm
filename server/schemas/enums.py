...
class EnumResponse(BaseModel):
    ...
    enum_type: str = Field(..., description="Type of enum (e.g., 'bandpass', 'depth_unit')")
...
class AllEnumsResponse(BaseModel):
    ...
    enums: Dict[str, List[EnumOption]] = Field(..., description="Dictionary of all enum types and their options")