<script lang="ts">
	...
	function updateVisualization() {
		...
		try {
			...
			console.log('Checking footprints:', { showFootprints, footprintData: !!footprintData, footprintDataLength: footprintData?.length });
	...
	function getMarkerData(dataType: string) {
		switch (dataType) {
			case 'galaxies': return galaxyData;
			case 'candidates': return candidateData;
			case 'icecube': return icecubeData;
			default: return [];
		}
	}
