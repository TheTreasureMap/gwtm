    ...
    <div class="flex items-center">
      ...
      <div>
        ...
        <p class="text-yellow-700">
          The interactive Jupyter tutorial is currently being updated for the new API. 
          In the meantime, please use the resources below.
        </p>
      </div>
    </div>
  </div>
  ...
  <div class="grid md:grid-cols-2 gap-6 mb-8">
    <div class="bg-white rounded-lg shadow-lg p-6">
      ...
      <p class="text-gray-600 mb-4">
        The easiest way to get started is with our official Python library that provides 
        high-level functions and examples.
      </p>
      <a 
    ...
    <div class="bg-white rounded-lg shadow-lg p-6">
      ...
      <p class="text-gray-600 mb-4">
        Explore all available endpoints with live examples and the ability to test 
        API calls directly from your browser.
      </p>
      <a 
    ...
    <div class="space-y-6">
      ...
      <div>
        ...
        <div class="bg-gray-900 rounded-lg p-4 overflow-x-auto">
          <pre class="text-green-400 text-sm"><code># First, register for an account and get your API token
import requests
...
{'}'}</code></pre>
      ...
      <div>
        ...
        <div class="bg-gray-900 rounded-lg p-4 overflow-x-auto">
          <pre class="text-green-400 text-sm"><code># Get pointings for a specific GW event
...
print(f"Found {'{'}{len(pointings)}{'}'} pointings for S190425z")</code></pre>
        </div>
      </div>
      ...
      <div>
        ...
        <div class="bg-gray-900 rounded-lg p-4 overflow-x-auto">
          <pre class="text-green-400 text-sm"><code># Submit a planned pointing
